...
def reverseLinkedList(input: Optional[Node]) -> Optional[Node]:
    """
    This function reverse the order of the given linked list.
    >>> str(reverseLinkedList(Node(1, Node(2, Node(3)))))
    '3, 2, 1'
    >>> str(reverseLinkedList(None))
    'None'
    >>> str(reverseLinkedList(Node('First', Node('Second'))))
    'Second, First'
    """
    ...
    # Pop data off temp and push them into output. Repeatedly.
